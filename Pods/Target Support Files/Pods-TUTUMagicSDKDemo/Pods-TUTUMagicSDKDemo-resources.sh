...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/TUTUMagicSDK/Localization/Base.lproj"
  install_resource "${PODS_ROOT}/TUTUMagicSDK/Localization/en.lproj"
  install_resource "${PODS_ROOT}/TUTUMagicSDK/Localization/zh-Hant.lproj"
fi
